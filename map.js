...
info.update = function (props) {
    ...
    this._div.innerHTML = '<h4>Life Expectancy and Building Density</h4>' +  (props ?
        '<b>' +'Life Expectancy'+' '+ props['Life Expectancy'] + '</b><br />' +'<b>Building Density'+' '+ props['building_density'] +'</b><br />'+ props.NAMELSAD + '</b><br />'+  mappedName
        : 'Hover over an area');
};
...
addLayer('data/newyorkcity.geojson', function (feature) {
    const type = feature.properties['life+buildingdensity'];
    return {
        color: "#848484",
        weight: 0.5,
...
legend.onAdd = function (map) {
  ...
  var div_type = L.DomUtil.create('div', 'legend-section', container),
      ...
      typeLabels = ['Low life expectancy / Low building density', 'Low L.E. / Moderate B.D.', 'Low L.E. / High B.D.', 'Low L.E. / Very high B.D.', 'Moderate L.E. / Low B.D.', 'Moderate L.E. / Moderate B.D.', 'Moderate L.E. / High B.D.', 'Moderate L.E. / Very high B.D.','High L.E. / Low B.D.','High L.E. / Moderate B.D.','High L.E. / High B.D.','High L.E. / Very high v','Very high L.E. / Low B.D.','Very high L.E. / Moderate B.D.','Very high L.E. / High B.D.','Very high L.E. / Very high B.D.'];
